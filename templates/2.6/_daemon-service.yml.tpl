  ...
  control-plane:
    ...
    environment:
      ...
      # Auto-migrate-pulsar — 2.5 only; included on the 2.6 template
      # so cluster.env's defaults parse uniformly. The watchdog gates
      # this on MQ_TYPE=pulsar so on 2.6 (woodpecker) it's a no-op.
