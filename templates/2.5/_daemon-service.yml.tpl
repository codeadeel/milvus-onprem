  ...
  control-plane:
    ...
    environment:
      ...
      # Auto-migrate-pulsar on PULSAR_HOST failure (2.5 only). Default
      # false; opt-in by setting AUTO_MIGRATE_PULSAR_ON_HOST_FAILURE=true
      # in cluster.env. Migrate-pulsar drops in-flight messages — see
      # docs/FAILOVER.md before enabling.
      - MILVUS_ONPREM_AUTO_MIGRATE_PULSAR_ON_HOST_FAILURE=${AUTO_MIGRATE_PULSAR_ON_HOST_FAILURE}
